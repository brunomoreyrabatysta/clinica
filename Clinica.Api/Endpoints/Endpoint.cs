...
public static class Endpoint
{
    public static void MapEndpoints(this WebApplication app)
    {
        ...
        endPoints
            .MapGroup("v1/responsaveis")
            .WithTags("Responsveis")
            .RequireAuthorization()
            .MapEndpoint<CriarResponsavelEndpoint>()
            .MapEndpoint<AlterarResponsavelEndpoint>()
            .MapEndpoint<ExcluirResponsavelEndpoint>()
        ...
        endPoints
            .MapGroup("v1/profissionais")
            .WithTags("Profissionais")
            .RequireAuthorization()
            .MapEndpoint<CriarProfissionalEndpoint>()
            .MapEndpoint<AlterarProfissionalEndpoint>()
            .MapEndpoint<ExcluirProfissionalEndpoint>()
