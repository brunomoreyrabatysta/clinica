...
public class AlterarCursoRequest : BaseRequest
{
    [Required(ErrorMessage = "O código do curso não foi preenchido!")]
    public long Id { get; set; }

    [Required(ErrorMessage = "O título do curso não foi preenchido!")]
